/**
 * The app's icon set, inlined as path data.
 *
 * Nothing is fetched at runtime. The app is fully offline, so an icon font or a sprite
 * pulled from a CDN would resolve to empty boxes exactly when the user has no connection,
 * which for this app is most of the time by design.
 */
